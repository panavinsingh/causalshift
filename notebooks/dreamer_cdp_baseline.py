"""Dreamer-CDP baseline on CausalShift — Kaggle GPU notebook.

Dreamer-CDP: reconstruction-free DreamerV3 variant with JEPA-style
...
- Dreamer-CDP: encoder + latent predictor (predicts next latent, no decoder)
...
with open("dreamer_cdp_xor_results.json", "w") as f:
    json.dump({"baseline": "dreamer_cdp", "env": "xor", "summary": summary, "per_seed": all_results}, f, indent=2)

print("\n" + "=" * 60)
print("RESULTS: Dreamer-CDP on XOR")
print("=" * 60)
for theta in SHIFT_LEVELS:
